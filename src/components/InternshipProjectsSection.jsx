...
function InternshipProjectsSection() {
  const projects = [
    ...
    {
      title: "Sustainability Summit Iloilo",
      slug: "sustainability-summit-iloilo",
      description:
        "Developed a multi-step attendance management system for Sustainability Summit Iloilo, featuring attendee search, details verification, digital signature capture, and integrations with Prisma and Cloudinary for efficient data and signature management.",
      tech: ["Next.js", "Prisma", "Cloudinary", "PostgreSQL"],
      icon: FolderKanban,
    },
  ];
